...
public class CurrentWeatherData {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/weather", params = {"name"})
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/weather", params = {"name", "code"})
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/weather", params = {"id"})
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/weather", params = {"lon", "lat"})
    public WeatherData byGeoCoord(
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/weather", params = {"zip"})
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/weather", params = {"zip", "code"})
    public WeatherData byZipCode(
	    @RequestParam(defaultValue = "94040") String zip,
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/box", params = {"lonLeft", "lonRight", "latBottom", "latTop", "zoom"})
    public WeatherData withinRectangle(@RequestParam(defaultValue = "12") String lonLeft,
	...
	return restTemplate.getForObject(Setting.defaultUrl + "/box/city?bbox=" + lonLeft + "," + latBottom + ","
		+ lonRight + "," + latTop + "," + zoom + "&APPID=" + Setting.getApi(), WeatherData.class);
    } // limit of 25 square degrees

    @RequestMapping(method = RequestMethod.GET, value = "/box", params = {"lonLeft", "lonRight", "latBottom", "latTop", "zoom", "cluster", "lang"})
    public WeatherData withinRectangle(@RequestParam(defaultValue = "12") String lonLeft,
	    @RequestParam(defaultValue = "32") String latBottom, 
	    @RequestParam(defaultValue = "15") String lonRight,
	    @RequestParam(defaultValue = "37") String latTop, 
	...
	return restTemplate.getForObject(
		Setting.defaultUrl + "/box/city?bbox=" + lonLeft + "," + latBottom + "," + lonRight + "," + latTop + ","
			+ zoom + "&lang=" + lang + "&cluster=" + cluster + "&APPID=" + Setting.getApi(),
		WeatherData.class);
    } // limit of 25 square degrees

    @RequestMapping(method = RequestMethod.GET, value = "/find", params = {"lat", "lon", "cnt"})
	...
	return restTemplate.getForObject(
		Setting.defaultUrl + "/find?lat=" + lat + "&lon=" + lon + "&cnt=" + cnt + "&APPID=" + Setting.getApi(),
		WeatherData.class);
    } // limit of 25 square degrees

    @RequestMapping(method = RequestMethod.GET, value = "/find", params = {"lat", "lon", "cnt", "cluster", "lang"})
    public WeatherData inCycle(
	    @RequestParam(defaultValue = "37") String lon,
	    @RequestParam(defaultValue = "55.5") String lat,
	    @RequestParam(defaultValue = "10") String cnt,
	...
	return restTemplate
		.getForObject(
			Setting.defaultUrl + "/find?lat=" + lat + "&lon=" + lon + "&cnt=" + cnt + "&cluster=" + cluster
				+ "&lang=" + lang + "&callback=" + callback + "&APPID=" + Setting.getApi(),
			WeatherData.class);
    } // limit of 25 square degrees
